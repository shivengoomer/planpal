const Header = () => {
  return (
    <header className="flex justify-center items-center sticky top-0 z-50">
      <nav className="mt-10 backdrop-blur-sm px-1 bg-black/25  shadow shadow-green-300 rounded-4xl w-xl py-5 flex flex-row justify-center gap-15 text-2xl text-white font-small">
